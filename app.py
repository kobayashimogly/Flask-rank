...
# 環境変数からGoogleサービスアカウントの情報を取得して一時ファイルに保存
service_account_content = os.getenv("GOOGLE_CREDENTIALS")
service_account_file_path = "/tmp/google_credentials.json"

with open(service_account_file_path, "w") as f:
    f.write(base64.b64decode(service_account_content).decode('utf-8'))
